...
public class FractalExplorer {
    ...
    class FractalWorker extends javax.swing.SwingWorker<Object, Object> { // вычисляем строки для фрактала
    ...
    private void enableUI(boolean val){ //включает и выключает кнопки
    ...
    private void drawFractal(){
        enableUI(false);// отключает все элементы во время перерисовки
